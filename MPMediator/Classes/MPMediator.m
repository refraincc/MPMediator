...
NSString * const kMPMediatorParamsKeySwiftTargetModuleName = @"kMPMediatorParamsKeySwiftTargetModuleName";
...
{
    static MPMediator *mediator;
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        mediator = [[MPMediator alloc] init];
...
- (id)performTarget:(NSString *)targetName action:(NSString *)actionName params:(NSDictionary *)params shouldCacheTarget:(BOOL)shouldCacheTarget
{
    ...
    NSString *swiftModuleName = params[kMPMediatorParamsKeySwiftTargetModuleName];
...
MPMediator* _Nonnull CT(void){
    return [MPMediator sharedInstance];
};
